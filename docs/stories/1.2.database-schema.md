...
## Status
Done (Later Deprecated - See Note Below)

**DEPRECATION NOTE:** The `wiki_chunk` table created in this story was later removed in favor of ChromaDB-only storage. ChromaDB fully duplicates all chunk data (text, metadata, article_title, section_path, etc.), making the SQLite table redundant. The table was removed to eliminate data duplication and sync complexity. See removal plan: `docs/plan-remove-sqlite-wiki-chunk.md`
...
| 2026-01-02 | 1.3 | **DEPRECATED**: wiki_chunk table and related code removed - ChromaDB is now sole chunk storage | Dev Agent |
