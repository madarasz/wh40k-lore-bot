...
- [x] Task 5: Add language support (AC: 8)
  - [x] Define language-specific headers (HU: "Források", EN: "Sources")
...
```
Roboute Guilliman a Birodalom egyik legerősebb harcosa és az Ultramarines
légiójának primarchája. A 13. légió alapítója és vezetője...

Az Császár védelme legyen veled, halandó.
...
**Smalltalk:**
```
Üdvözöllek a 41. évezredben! Készen állok válaszolni a kérdéseidre.
```

### Relevant Source Tree
```
src/llm/
├── __init__.py                          # Export ResponseFormatter
├── structured_output.py                 # LLMStructuredResponse (from 2.3)
├── response_formatter.py                # NEW: ResponseFormatter class
tests/unit/
├── test_response_formatter.py           # NEW: ResponseFormatter tests
```
...
### Pull Request
_To be created after QA approval_
