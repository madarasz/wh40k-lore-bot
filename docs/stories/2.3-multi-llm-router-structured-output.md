...
| 2026-01-10 | 2.1 | Story 2.5 modifications: Removed generate() and LLMResponse (structured only), removed fallback logic, added system_prompt to GenerationOptions, added language field to LLMStructuredResponse | Claude Opus 4.5 |
